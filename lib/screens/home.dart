...
import 'package:traveller_app/services/travel_api_service.dart';
  ...
  Widget _buildLocationInput(String hint, bool isFrom) {
      final controller =
          isFrom
              ? TextEditingController(text: _departureLocation)
              : TextEditingController(text: _destinationLocation);

      bool isUpdatingProgrammatically = false; // Add this flag
      ...
      return Column(
        ...
        children: [
          ...
          if ((isFrom
            ...
            _buildSuggestions(isFrom, controller, (bool value) {
    ...
    Widget _buildSuggestions(
      ...
      Function(bool) setProgrammatic,
    ) {
      final destinationProvider = Provider.of<DestinationProvider>(context);
      final query = isFrom ? _departureLocation : _destinationLocation;
      final suggestions =
            ...
            itemBuilder: (context, index) {
              return ListTile(
                ...
                onTap: () {
                  ...
                  setState(() {
                    if (isFrom) {
                      _departureLocation = suggestions[index].name;
                    } else {
                      _destinationLocation = suggestions[index].name;
                    }
